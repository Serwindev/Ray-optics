...
var ASM_CONSTS = {
  89022: () => { if (document.fullscreenElement) return 1; },  
 89068: () => { return Module.canvas.width; },  
 89100: () => { return parseInt(Module.canvas.style.width); },  
 89148: () => { document.exitFullscreen(); },  
 89175: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89247: () => { if (document.fullscreenElement) return 1; },  
 89293: () => { return Module.canvas.width; },  
 89325: () => { return screen.width; },  
 89350: () => { document.exitFullscreen(); },  
 89377: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89571: () => { return window.innerWidth; },  
 89597: () => { return window.innerHeight; },  
 89624: () => { if (document.fullscreenElement) return 1; },  
 89670: () => { return Module.canvas.width; },  
 89702: () => { return parseInt(Module.canvas.style.width); },  
 89750: () => { if (document.fullscreenElement) return 1; },  
 89796: () => { return Module.canvas.width; },  
 89828: () => { return screen.width; },  
 89853: () => { return window.innerWidth; },  
 89879: () => { return window.innerHeight; },  
 89906: () => { if (document.fullscreenElement) return 1; },  
 89952: () => { return Module.canvas.width; },  
 89984: () => { return screen.width; },  
 90009: () => { document.exitFullscreen(); },  
 90036: () => { if (document.fullscreenElement) return 1; },  
 90082: () => { return Module.canvas.width; },  
 90114: () => { return parseInt(Module.canvas.style.width); },  
 90162: () => { document.exitFullscreen(); },  
 90189: ($0) => { Module.canvas.style.opacity = $0; },  
 90227: () => { return screen.width; },  
 90252: () => { return screen.height; },  
 90278: () => { return window.screenX; },  
 90305: () => { return window.screenY; },  
 90332: () => { return window.devicePixelRatio; },  
 90368: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90421: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90472: () => { Module.canvas.style.cursor = 'none'; },  
 90509: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90765: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90816: () => { if (document.pointerLockElement) return 1; },  
 90863: () => { if (document.fullscreenElement) return 1; },  
 90909: () => { return window.innerWidth; },  
 90935: () => { return window.innerHeight; }
};
